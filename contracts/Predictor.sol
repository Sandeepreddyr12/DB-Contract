...
contract gamePredictor is AutomationCompatibleInterface {
    ...
    mapping(uint256 => ContestDetails) public contestEntrances;
    ...
    function createContest() internal view {
    ...
    function isValidContest(uint256 _contestId) internal view returns (bool) {
    ...
    function declareResult(
        uint256 _contestId // string memory _winningTeam
    ) internal view {
    ...
    function withDrawBalance() public view {
